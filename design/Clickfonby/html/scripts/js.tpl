<!--  request  -->
<script src="design/{$settings->theme|escape}/js/jquery-3.0.0.min.js"></script>
<script src="design/{$settings->theme|escape}/js/jquery-migrate-3.0.0.min.js"></script>
<script src="design/{$settings->theme|escape}/js/bootstrap.bundle.min.js"></script>
<script src="design/{$settings->theme|escape}/js/wow.min.js"></script>
<script src="design/{$settings->theme|escape}/js/jquery.fancybox.js"></script>
<script src="design/{$settings->theme|escape}/js/lity.js"></script>
<script src="design/{$settings->theme|escape}/js/swiper8-bundle.min.js"></script>
<script src="design/{$settings->theme|escape}/js/jquery.waypoints.min.js"></script>
<script src="design/{$settings->theme|escape}/js/jquery.counterup.js"></script>
<script src="design/{$settings->theme|escape}/js/parallaxie.js"></script>
<script src="design/{$settings->theme|escape}/js/iziToast.min.js"></script>
<!-- ===== gsap scripts ===== -->
<script src="design/{$settings->theme|escape}/js/gsap.min.js"></script>
...
<script src="design/{$settings->theme|escape}/js/common_js.js"></script>
