<?php
/* Smarty version 5.4.2, created on 2025-11-23 12:41:36
  from 'file:articles_categories.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_6922d6d0d55454_74904135',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a39833c959b951b0266c445f4bf838a4a17fcd52' => 
    array (
      0 => 'articles_categories.tpl',
      1 => 1734791784,
      2 => 'file',
    ),
  ),
...
function content_6922d6d0d55454_74904135 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->getSmarty()->getRuntime('TplFunction')->registerTplFunctions($_smarty_tpl, array (
  'categories_tree' => 
  array (
    'compiled_filepath' => '/home/clickfon/public_html/turbo/design/compiled/a39833c959b951b0266c445f4bf838a4a17fcd52_0.file_articles_categories.tpl.php',
    'uid' => 'a39833c959b951b0266c445f4bf838a4a17fcd52',
    'call_name' => 'smarty_template_function_categories_tree_4771578616922d6d0d2ee41_29490416',
  ),
));
...
<div class="d-md-flex mb-3">
	...
	<div class="d-grid gap-2 d-sm-block mt-2 mt-md-0">
		<a class="btn btn-primary" href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'ArticlesCategoryAdmin','return'=>$_SERVER['REQUEST_URI']), $_smarty_tpl);?>
...
<div class="card">
	<div class="card-body">
		<?php if ($_smarty_tpl->getValue('articles_categories')) {?>
...
">
				<div class="turbo-list">
					<div class="turbo-list-head">
						...
						<div class="turbo-list-heading turbo-list-photo hidden-sm-down"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('btr')->global_photo, ENT_QUOTES, 'UTF-8', true);?>
</div>
					...
					<div class="turbo-list-body categories-wrap sortable">
						...
						<?php $_smarty_tpl->getSmarty()->getRuntime('TplFunction')->callTemplateFunction($_smarty_tpl, 'categories_tree', array('articles_categories'=>$_smarty_tpl->getValue('articles_categories')), true);?>
...
<?php echo '</script'; ?>
><?php }
/* smarty_template_function_categories_tree_4771578616922d6d0d2ee41_29490416 */
if (!function_exists('smarty_template_function_categories_tree_4771578616922d6d0d2ee41_29490416')) {
function smarty_template_function_categories_tree_4771578616922d6d0d2ee41_29490416(\Smarty\Template $_smarty_tpl,$params) {
$_smarty_current_dir = '/home/clickfon/public_html/turbo/design/html';
...
?>
							...
							<?php if ($_smarty_tpl->getValue('articles_categories')) {?>
								<?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('articles_categories'), 'category');
$foreach0DoElse = true;
...
">
												...
												<div class="turbo-list-boding turbo-list-photo turbo-list-category-photo hidden-sm-down small-photo boding-small">
													<?php if ($_smarty_tpl->getValue('category')->image) {?>
														<a href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'ArticlesCategoryAdmin','id'=>$_smarty_tpl->getValue('category')->id,'return'=>$_SERVER['REQUEST_URI']), $_smarty_tpl);?>
">
...
">
												...
												<div class="turbo-list-boding turbo-list-categories-name">
													<a class="fw-bold text-body text-decoration-none" href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'ArticlesCategoryAdmin','id'=>$_smarty_tpl->getValue('category')->id,'return'=>$_SERVER['REQUEST_URI']), $_smarty_tpl);?>
">
...
" data-module="articles_category" data-action="visible" data-id="<?php echo $_smarty_tpl->getValue('category')->id;?>
...
"></label>
												...
												<div class="turbo-list-setting">
													<a href="../articles/<?php echo $_smarty_tpl->getValue('category')->url;?>
...
">
 ...
 sortable" style="display: none;">
													<?php $_smarty_tpl->getSmarty()->getRuntime('TplFunction')->callTemplateFunction($_smarty_tpl, 'categories_tree', array('articles_categories'=>$_smarty_tpl->getValue('category')->subcategories,'level'=>$_smarty_tpl->getValue('level')+1), true);?>
