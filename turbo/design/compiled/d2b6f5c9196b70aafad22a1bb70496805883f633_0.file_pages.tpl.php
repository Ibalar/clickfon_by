<?php
/* Smarty version 5.4.2, created on 2025-11-14 18:52:05
  from 'file:pages.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_6917502513e093_40687981',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd2b6f5c9196b70aafad22a1bb70496805883f633' => 
    array (
      0 => 'pages.tpl',
      1 => 1733362702,
      2 => 'file',
...
function content_6917502513e093_40687981 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->getSmarty()->getRuntime('TplFunction')->registerTplFunctions($_smarty_tpl, array (
  'pages_tree' => 
  array (
    'compiled_filepath' => '/home/clickfon/public_html/turbo/design/compiled/d2b6f5c9196b70aafad22a1bb70496805883f633_0.file_pages.tpl.php',
    'uid' => 'd2b6f5c9196b70aafad22a1bb70496805883f633',
    'call_name' => 'smarty_template_function_pages_tree_136464938569175025119a99_01159285',
  ),
));
$_smarty_tpl->assign('meta_title', $_smarty_tpl->getValue('menu')->name, false, 32);?>

<div class="d-md-flex mb-3">
	<h1 class="d-inline align-middle me-3"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('menu')->name, ENT_QUOTES, 'UTF-8', true);?>
</h1>
	<div class="d-grid gap-2 d-sm-block mt-2 mt-md-0">
		<a class="btn btn-primary" href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'PageAdmin','return'=>$_SERVER['REQUEST_URI']), $_smarty_tpl);?>
"><i data-feather="plus"></i> <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('btr')->pages_add, ENT_QUOTES, 'UTF-8', true);?>
</a>
	</div>
</div>
...
">
				<div class="turbo-list ">
					<div class="turbo-list-head">
						...
						<div class="turbo-list-heading turbo-list-categories-name"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('btr')->pages_name, ENT_QUOTES, 'UTF-8', true);?>
</div>
					...
					<div class="turbo-list-body categories-wrap sortable">
						...
						<?php $_smarty_tpl->getSmarty()->getRuntime('TplFunction')->callTemplateFunction($_smarty_tpl, 'pages_tree', array('pages'=>$_smarty_tpl->getValue('pages')), true);?>
		...
		<?php } else { ?>
			<h5 class="card-title ms-1 my-3"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('btr')->pages_no, ENT_QUOTES, 'UTF-8', true);?>
</h5>
		<?php }?>
	</div>
</div>
...
<?php echo '</script'; ?>
><?php }
/* smarty_template_function_pages_tree_136464938569175025119a99_01159285 */
if (!function_exists('smarty_template_function_pages_tree_136464938569175025119a99_01159285')) {
function smarty_template_function_pages_tree_136464938569175025119a99_01159285(\Smarty\Template $_smarty_tpl,$params) {
$_smarty_current_dir = '/home/clickfon/public_html/turbo/design/html';
$params = array_merge(array('name'=>'pages_tree','level'=>1), $params);
...
?>
									<?php if ($_smarty_tpl->getValue('level') > 1) {?>
										...
										<div class="js-row <?php if ($_smarty_tpl->getValue('level') == 1) {?>turbo-list-body-item<?php }?> js-sort-item body-narrow row-narrow">
											<div class="turbo-list-row <?php if ($_smarty_tpl->getValue('level') > 1) {?>js-sort-item<?php }?> narrow">
												<input type="hidden" name="positions[<?php echo $_smarty_tpl->getValue('page')->id;?>
]" value="<?php echo $_smarty_tpl->getValue('page')->position;?>
">
												<?php if ($_smarty_tpl->getValue('page')->subpages) {?>
													<div class="turbo-list-heading turbo-list-subicon">
														<a href="javascript:;" class="js-ajax-toggle" data-toggle="0" data-category_id="<?php echo $_smarty_tpl->getValue('page')->id;?>
">
												...
												<div class="turbo-list-boding turbo-list-check">
													<label class="form-check">
														<input class="form-check-input js-check-all-single" type="checkbox" name="check[]" value="<?php echo $_smarty_tpl->getValue('page')->id;?>
">
													</label>
												</div>
												<div class="turbo-list-boding turbo-list-categories-name">
													<a href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'PageAdmin','id'=>$_smarty_tpl->getValue('page')->id,'return'=>$_SERVER['REQUEST_URI']), $_smarty_tpl);?>
" class="fw-bold text-body text-decoration-none">
														<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('page')->header, ENT_QUOTES, 'UTF-8', true);?>
												...
												<div class="turbo-list-boding turbo-list-status">
													<div class="form-check form-switch">
														<input class="form-check-input js-ajax-action <?php if ($_smarty_tpl->getValue('page')->visible) {?>js-active-class<?php }?>" id="id-<?php echo $_smarty_tpl->getValue('page')->id;?>
" data-module="page" data-action="visible" data-id="<?php echo $_smarty_tpl->getValue('page')->id;?>
" name="visible" value="1" type="checkbox" <?php if ($_smarty_tpl->getValue('page')->visible) {?>checked=""<?php }?>>
														<label class="form-check-label" for="id-<?php echo $_smarty_tpl->getValue('page')->id;?>
"></label>
													</div>
												</div>
...
">
 ...
 sortable" style="display: none;">
													<?php $_smarty_tpl->getSmarty()->getRuntime('TplFunction')->callTemplateFunction($_smarty_tpl, 'pages_tree', array('pages'=>$_smarty_tpl->getValue('page')->subpages,'level'=>$_smarty_tpl->getValue('level')+1), true);?>
