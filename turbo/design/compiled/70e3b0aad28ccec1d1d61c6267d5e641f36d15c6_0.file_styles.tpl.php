<?php
/* Smarty version 5.4.2, created on 2025-12-04 15:28:03
  from 'file:styles.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_69317e5349c114_85895506',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '70e3b0aad28ccec1d1d61c6267d5e641f36d15c6' => 
    array (
      0 => 'styles.tpl',
      1 => 1733374858,
      2 => 'file',
...
function content_69317e5349c114_85895506 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/home/clickfon/public_html/turbo/design/html';
if ($_smarty_tpl->getValue('style_file')) {?>
	<?php $_smarty_tpl->assign('meta_title', ((string)$_smarty_tpl->getValue('btr')->global_style)." ".((string)$_smarty_tpl->getValue('style_file')), false, 32);
}?>
...
, <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('btr')->global_style, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo $_smarty_tpl->getValue('style_file');?>
</h1>
...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb mb-3">
		<li class="breadcrumb-item"><a href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'StylesAdmin','file'=>null,'dir'=>null), $_smarty_tpl);?>
" class="text-decoration-none text-muted">
				<i class="align-middle text-warning mt-n1" data-feather="folder"></i>
				css
			</a>
		</li>
		<?php if ((null !== ($_GET['dir'] ?? null)) && !$_smarty_tpl->getValue('style_file')) {?>
			<li class="breadcrumb-item active">
				<?php echo $_GET['dir'];?>

			</li>
		<?php } elseif ((null !== ($_GET['dir'] ?? null)) && $_smarty_tpl->getValue('style_file')) {?>
			<li class="breadcrumb-item active">
				<a href="/turbo/index.php?module=StylesAdmin&dir=<?php echo $_GET['dir'];?>
" class="text-decoration-none text-muted">
					<i class="align-middle text-warning mt-n1" data-feather="folder"></i>
					<?php echo $_GET['dir'];?>
			...
			<li class="breadcrumb-item active">
				<i class="align-middle mt-n1" data-feather="file-text"></i> <?php echo $_smarty_tpl->getValue('style_file');?>

			</li>
		<?php } elseif ($_smarty_tpl->getValue('style_file')) {?>
			<li class="breadcrumb-item active">
				<i class="align-middle mt-n1" data-feather="file-text"></i> <?php echo $_smarty_tpl->getValue('style_file');?>
...
?>
								<li class="nav-item">
									<a class="nav-link text-decoration-none <?php if ($_smarty_tpl->getValue('f') == $_smarty_tpl->getValue('dir')) {?>active text-white<?php } else { ?>text-muted<?php }?>" aria-current="page" href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'StylesAdmin','file'=>null,'dir'=>$_smarty_tpl->getValue('f')), $_smarty_tpl);?>
">
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<h5 class="card-title mb-0"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('btr')->global_styles, ENT_QUOTES, 'UTF-8', true);?>
</h5>
			</div>
			<div class="collapse-card">
				<div class="card-body">
...
?>
							<li class="nav-item">
								<a class="nav-link text-decoration-none <?php if ($_smarty_tpl->getValue('style_file') == $_smarty_tpl->getValue('s')) {?>active text-white<?php } else { ?>text-muted<?php }?>" aria-current="page" href="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('url')->handle(array('module'=>'StylesAdmin','file'=>$_smarty_tpl->getValue('s')), $_smarty_tpl);?>
">
...
<?php if ($_smarty_tpl->getValue('style_file')) {?>
	<div class="row">
		<div class="col-12">
			<div class="card mh-230px">
				<div class="card-header">
					...
					<h5 class="card-title mb-0"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('btr')->global_style, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('style_file'), ENT_QUOTES, 'UTF-8', true);?>
</h5>
				</div>
				<div class="collapse-card">
					<div class="card-body">
						<form>
							<textarea id="content" class="d-none" name="content"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('style_content'), ENT_QUOTES, 'UTF-8', true);?>
</textarea>
						</form>
						<div class="row">
							<div class="col-12">
...
echo $_smarty_tpl->getSmarty()->getBlockHandler('js')->handle(array('id'=>"codemirror-css",'priority'=>99,'include'=>array("turbo/design/js/codemirror/lib/codemirror.js","turbo/design/js/codemirror/mode/css/css.js","turbo/design/js/codemirror/addon/selection/active-line.js")), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
  ob_start();
$_block_repeat=false;
echo $_smarty_tpl->getSmarty()->getBlockHandler('js')->handle(array('id'=>"codemirror-css",'priority'=>99,'include'=>array("turbo/design/js/codemirror/lib/codemirror.js","turbo/design/js/codemirror/mode/css/css.js","turbo/design/js/codemirror/addon/selection/active-line.js")), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
', 'style': '<?php echo $_smarty_tpl->getValue('style_file');?>
