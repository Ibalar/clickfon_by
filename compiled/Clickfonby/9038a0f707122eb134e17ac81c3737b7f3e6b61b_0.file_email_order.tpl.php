...
/* Smarty version 5.4.2, created on 2025-11-23 15:43:18
  from 'file:/home/clickfon/public_html/design/Clickfonby/html/email/email_order.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_69230166291a73_61002043',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9038a0f707122eb134e17ac81c3737b7f3e6b61b' => 
    array (
      0 => '/home/clickfon/public_html/design/Clickfonby/html/email/email_order.tpl',
      1 => 1763793617,
      2 => 'file',
    ),
  ),
...
function content_69230166291a73_61002043 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/home/clickfon/public_html/design/Clickfonby/html/email';
$_smarty_tpl->assign('subject', ((string)$_smarty_tpl->getValue('lang')->email_order_title)." ".((string)$_smarty_tpl->getValue('order')->id), false, 32);?>
<html xmlns="http://www.w3.org/1999/xhtml">

<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_order_title, ENT_QUOTES, 'UTF-8', true);?>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="es-p10t es-p15b" align="center">
                                            <h1><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_order_heading, ENT_QUOTES, 'UTF-8', true);?>
 <span class="es-number-order">№ <?php echo $_smarty_tpl->getValue('order')->id;?>
                                        ...
                                        <tr>
                                          <td class="es-p10t es-p0b es-p30r es-p30l" align="center">
                                            <p><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_comment_hello, ENT_QUOTES, 'UTF-8', true);?>
 <i><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('order')->name, ENT_QUOTES, 'UTF-8', true);?>
</i>. <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_order_message, ENT_QUOTES, 'UTF-8', true);?>
 <strong>№<?php echo $_smarty_tpl->getValue('order')->id;?>
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_from, ENT_QUOTES, 'UTF-8', true);?>
...
.</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_order_text_status, ENT_QUOTES, 'UTF-8', true);?>
</p>
                                            <span class="es-status-color"><?php if ($_smarty_tpl->getValue('order')->status == 0) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->waiting_processing, ENT_QUOTES, 'UTF-8', true);
} elseif ($_smarty_tpl->getValue('order')->status == 1) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->in_processing, ENT_QUOTES, 'UTF-8', true);
} elseif ($_smarty_tpl->getValue('order')->status == 2) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->completed, ENT_QUOTES, 'UTF-8', true);
} elseif ($_smarty_tpl->getValue('order')->status == 3) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->canceled, ENT_QUOTES, 'UTF-8', true);
}?></span>
                                          </td>
                                        </tr>
                                        <tr>
...
" class="es-button" target="_blank"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_order_button, ENT_QUOTES, 'UTF-8', true);?>
</a>
                                          </td>
                                        </tr>
                                      </tbody>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="esd-block-text" align="left">
                                                    <h4><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->order_details, ENT_QUOTES, 'UTF-8', true);?>
:</h4>
                                                  </td>
                                                </tr>
                                              </tbody>
                                ...
                                <tr>
                                  <td class="es-m-p20b" width="100%" align="left">
                                    <table class="es-table-infobox" cellspacing="1" cellpadding="1" border="0" align="left">
                                      <tbody>
                                        <tr valign="top">
                                          <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_order_number, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
                                          <td class="es-p5t es-p5b"><span>№ <?php echo $_smarty_tpl->getValue('order')->id;?>
</span></td>
                                        </tr>
                                        <tr valign="top">
                                          <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->order_date, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
...
:<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('time')($_smarty_tpl->getValue('order')->date);?>
                                        ...
                                        <tr valign="top">
                                          <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->email_order_status, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
                                          <td class="es-p5t es-p5b"><span><?php if ($_smarty_tpl->getValue('order')->status == 0) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->waiting_processing, ENT_QUOTES, 'UTF-8', true);
} elseif ($_smarty_tpl->getValue('order')->status == 1) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->in_processing, ENT_QUOTES, 'UTF-8', true);
} elseif ($_smarty_tpl->getValue('order')->status == 2) {
...
echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->canceled, ENT_QUOTES, 'UTF-8', true);
                                        ...
                                        <tr valign="top">
                                          <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->global_payment, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
                                          <td class="es-p5t es-p5b">
                                            <span>
                                              <?php if ($_smarty_tpl->getValue('order')->paid == 1) {?>
                                                <font color="green"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->paid, ENT_QUOTES, 'UTF-8', true);?>
</font>
                                              <?php } else { ?>
                                                <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->not_paid, ENT_QUOTES, 'UTF-8', true);?>
                                        ...
                                        <tr valign="top">
                                          <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->name, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
                                        ...
                                        <?php if ($_smarty_tpl->getValue('order')->phone) {?>
                                          <tr valign="top">
                                            <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->phone, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
                                        ...
                                        <?php if ($_smarty_tpl->getValue('order')->address) {?>
                                          <tr valign="top">
                                            <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->address, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
                                        ...
                                        <?php if ($_smarty_tpl->getValue('order')->comment) {?>
                                          <tr valign="top">
                                            <td class="es-p5t es-p5b" width="180px"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->comment, ENT_QUOTES, 'UTF-8', true);?>
:</span></td>
                                          ...
                                          <td class="es-m-p0r es-m-p20b" align="left">
                                            <table class="100%" cellspacing="0" cellpadding="0" align="left">
                                              <tbody>
                                                <tr>
                                                  <td class="esd-block-text" align="left">
                                                    <h4><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->you_ordered, ENT_QUOTES, 'UTF-8', true);?>
:</h4>
                                                  </td>
                                                </tr>
                                              </tbody>
...
" style="font-family: 'Trebuchet MS';font-size: 16px;color: #495057;text-decoration: none;line-height: normal;"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('purchase')->product_name, ENT_QUOTES, 'UTF-8', true);?>
 ...
 <?php if ($_smarty_tpl->getValue('purchase')->variant->color && $_smarty_tpl->getValue('purchase')->variant_name) {?>/<?php }?> <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('purchase')->variant_name, ENT_QUOTES, 'UTF-8', true);?>
                                                              ...
                                                              <?php if ($_smarty_tpl->getValue('order')->paid && $_smarty_tpl->getValue('purchase')->variant->attachment) {?>
                                                                <div class="es-p5t">
                                                                  <a class="es-download" href="<?php echo $_smarty_tpl->getValue('config')->root_url;?>
/<?php echo $_smarty_tpl->getValue('lang_link');?>
order/<?php echo $_smarty_tpl->getValue('order')->url;?>
/<?php echo $_smarty_tpl->getValue('purchase')->variant->attachment;?>
">
                                                                    <em><?php echo $_smarty_tpl->getValue('btr')->email_order_download;?>
</em>
                                                                  </a>
                                                                </div>
                                                              <?php }?>
                                                              <?php if ($_smarty_tpl->getValue('order')->paid && $_smarty_tpl->getValue('purchase')->variant->attachment_url) {?>
                                                                <div class="es-p5t">
                                                                  <a class="es-download" href="<?php echo $_smarty_tpl->getValue('purchase')->variant->attachment_url;?>
">
                                                                    <em><?php echo $_smarty_tpl->getValue('btr')->email_order_download;?>
</em>
                                                                  </a>
                                                    ...
                                                    <table style="width: 500px;" cellspacing="1" cellpadding="1" border="0" align="right">
                                                      <tbody>
                                                        <?php if ($_smarty_tpl->getValue('order')->discount) {?>
                                                          <tr>
                                                            <td style="text-align: right; font-size: 18px; line-height: 150%;"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->discount, ENT_QUOTES, 'UTF-8', true);?>
:</td>
...
&nbsp;%</td>
                                                        ...
                                                        <?php if ($_smarty_tpl->getValue('order')->coupon_discount > 0) {?>
                                                          <tr>
                                                            <td style="text-align: right; font-size: 18px; line-height: 150%;"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->coupon, ENT_QUOTES, 'UTF-8', true);?>
...
&nbsp;<?php echo $_smarty_tpl->getValue('currency')->sign;?>
                                                        ...
                                                        <?php if ($_smarty_tpl->getValue('order')->weight > 0) {?>
                                                          <tr>
                                                            <td style="text-align: right; font-size: 18px; line-height: 150%;"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->weight, ENT_QUOTES, 'UTF-8', true);?>
:</td>
...
&nbsp;<?php echo $_smarty_tpl->getValue('currency')->sign;?>
                                                        ...
                                                        <?php }?>
                                                        <tr class="es-p5t">
                                                          <td style="text-align: right; font-size: 20px; line-height: 150%;"><strong><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->total, ENT_QUOTES, 'UTF-8', true);?>
:</strong></td>
