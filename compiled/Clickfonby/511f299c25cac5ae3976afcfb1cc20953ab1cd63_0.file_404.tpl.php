<?php
/* Smarty version 5.4.2, created on 2026-01-16 15:08:07
  from 'file:404.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_696a2a27ead428_86885783',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '511f299c25cac5ae3976afcfb1cc20953ab1cd63' => 
    array (
      0 => '404.tpl',
      1 => 1763793689,
      2 => 'file',
...
function content_696a2a27ead428_86885783 (\Smarty\Template $_smarty_tpl) {
					...
					<div class="page_error_block">
						<div class="page_not_found" width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<div class="description">
								<div class="subtitle404 option-font-bold"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->page_not_found, ENT_QUOTES, 'UTF-8', true);?>
</div>
								<div class="descr_text404"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->text_404, ENT_QUOTES, 'UTF-8', true);?>
</div>
								<a class="btn btn-transparent-border btn-lg btn-mainpage has-ripple" onclick="history.back()"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->come_back, ENT_QUOTES, 'UTF-8', true);?>
</a>
								<a class="btn btn-default btn-lg btn-mainpage" href="<?php if ($_smarty_tpl->getValue('lang_link')) {
echo $_smarty_tpl->getValue('lang_link');
} else { ?>/<?php }?>"><span><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('lang')->to_main, ENT_QUOTES, 'UTF-8', true);?>
</span></a>
							</div>
						</div>
					</div>
